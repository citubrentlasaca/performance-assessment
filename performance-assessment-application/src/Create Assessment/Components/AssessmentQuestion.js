...
function AssessmentQuestion({ onDelete }) {
  ...
  const handleDeleteComponent = () => {
    ...
    onDelete(); // Call the onDelete prop to trigger the delete action in the parent component
  };

  const handleDeleteDuplicatedComponent = (key) => {
    const updatedComponents = duplicatedComponents.filter(
      (component) => component.key !== key
    );
    setDuplicatedComponents(updatedComponents);
  };
    ...
    <>
            ...
            >
              <Stack direction="column" justifyContent="center" alignItems="flex-start" spacing={2}>
                ...
                <Stack direction="row" justifyContent="center" alignItems="center">
                  ...
                  />
                  <IconButton onClick={handleDeleteComponent}>
      ...
      {duplicatedComponents.map((component) => (
        <AssessmentQuestion
          ...
          onDelete={() => handleDeleteDuplicatedComponent(component.key)}
        />
      ))}
    </>
  );
